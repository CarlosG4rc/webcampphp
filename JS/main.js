...
$(function(){
    ...
    $('.menu-programa a').on('click', function(){
        ...
        return false; //Para que no haga saltos
    });
    ...
    $('.resumen-evento li:nth-child(4) p').animateNumber({number:69},1200);

    //Cuenta regresiva
    $('.cuenta-regresiva').countdown('2021/07/14 06:00:00', function(event){
